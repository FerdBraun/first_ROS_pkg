    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'Reg/Strategy': '2',  # 1=Vis, 0=ICP
                'Vis/FeatureType': '6',  # ORB features
                'Icp/Iterations': '20',
                'Vis/MaxFeatures': '800',  # Уменьшили количество фич для уменьшения шума
                'Vis/MinInliers': '15',  # Увеличили минимальное количество inliers
                ...
                'Mem/STMSize': '30',  # Уменьшили размер кратковременной памяти
                'Mem/BadSignaturesIgnored': 'true',
                'Mem/ReduceGraph': 'true',
                'Mem/IncrementalMemory': 'false',
                'Mem/RehearsalSimilarity': '0.45',  # Более агрессивная очистка
                ...
                'Reg/Force3DoF': 'true',
                'RGBD/OptimizeMaxError': '3.0',  # Уменьшили максимальную ошибку
                ...
                'Grid/NoiseFilteringRadius': '0.15',  # Фильтрация шума
                'Grid/NoiseFilteringMinNeighbors': '5',  # Минимальное количество соседей
                'Grid/NormalSegmentation': 'true',
                'Grid/RangeMax': '2.5',                   # Макс. дальность обработки (меньше дефолтного)
                'Grid/RangeMin': '0.3', 
